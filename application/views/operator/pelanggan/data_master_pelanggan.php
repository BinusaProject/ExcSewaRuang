...
<body>
  ...
  <div class="container mx-auto px-4 md:px-6 lg:px-8">
    <div class="flex-2 p-3 w-full">
      <a href="tambah_pelanggan" class="bg-blue-500 hover:bg-blue-500 text-white rounded-lg py-2 px-full w-48 ml-auto mb-4 flex items-center justify-center">
        <i class="fas fa-plus-square text-xl mr-3"></i> Tambah Pelanggan
      </a>

      <table id="example" class="stripe hover responsive" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
        <thead>
          ...
          ?>
            <tr>
              ...
              <td class="whitespace-nowrap px-4 py-2 text-center text-gray-700">
                <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 md:py-2 md:px-3 rounded-lg" onclick="update(<?php echo $row->id ?>)">
                <i class="fas fa-check"></i>
                </button>

                <button onclick="hapus(<?php echo $row->id ?>)" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 md:py-2 md:px-3 rounded-lg ml-3">
