...
<body class="h-screen overflow-hidden flex flex-col bg-gray-100">
  <div class="min-h-screen overflow-hidden flex flex-col bg-gray-100">
          ...
          <div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-lg md:flex-row md:max-w-2xl dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-blue-700">
            <div class="w-full md:w-full lg:w-full md:rounded-l-lg">
              <?php if (!empty($row->image) && file_exists('./image/ruangan/' . $row->image)) : ?>
                <img class="object-fill w-full h-80 lg:h-80" src="<?php echo base_url('./image/ruangan/' . $row->image); ?>" alt="Room Image">
              <?php else : ?>
                <img class="object-fill w-full h-72 lg:h-72" src="<?php echo base_url('./image/foto.png'); ?>" alt="User Image">
              <?php endif; ?>
            </div>
            <div class="flex flex-col justify-between p-4 lg:p-6">
              <h5 class="mb-2 text-2xl lg:text-4xl text-center font-bold tracking-tight text-gray-900 dark:text-white"><?php echo format_ruangan($row->no_ruang); ?></h5>
              <p class="mb-3 font-normal text-lg text-center dark:text-gray-700"><?php echo convRupiah($row->harga); ?></p>
              <p class="mb-3 font-normal text-lg text-center dark:text-gray-700"><?php echo format_lantai($row->no_lantai); ?></p>
